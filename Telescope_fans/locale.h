...
const char mes36[] PROGMEM = VERSION " OLED";
const char mes37[] PROGMEM = VERSION " LCD";
...
const char mes45[] PROGMEM = "On";
const char mes46[] PROGMEM = "Off";
const char mes47[] PROGMEM = "Language";
const char mes48[] PROGMEM = "English";
const char mes49[] PROGMEM = "Russian";
...
const char mer16[] PROGMEM = "\337\360\352\356\361\362\374";                                    // "Яркость";
const char mer17[] PROGMEM = "\312\356\355\362\360\340\361\362";                                // "Контраст";
const char mer18[] PROGMEM = "\322\340\351\354\340\363\362";                                    // "Таймаут";
const char mer19[] PROGMEM = "\317\360\345\344\363\357\360. \342\345\355\362\350\353.";         // "Предупр. вентил.";
const char mer20[] PROGMEM = "\300\357\362\340\351\354";                                        // "Аптайм";
const char mer21[] PROGMEM = "\315\340\357\360\377\346\345\355\350\345 \357\350\362.";          // "Напряжение пит.";
const char mer22[] PROGMEM = "\316 \360\340\347\360\340\341\356\362\367\350\352\345";           // "О разработчике";
const char mer23[] PROGMEM = "\321\345\355\361\356\360\373";                                    // "Сенсоры";
const char mer24[] PROGMEM = "\317\340\360\340 \366\345\353\345\342. " DELTA "T";               // "Пара целев. " DELTA "T";
const char mer25[] PROGMEM = "\315\340\347\355\340\367\350\362\374 \361\345\355\361\356\360";   // "Назначить сенсор";
const char mer26[] PROGMEM = "\307\345\360\352\340\353\356";                                    // "Зеркало";
const char mer27[] PROGMEM = "\322\360\363\341\340";                                            // "Труба";
const char mer28[] PROGMEM = "\316\352\360\363\346\345\355\350\345";                            // "Окружение";
const char mer29[] PROGMEM = "\302\355\345\370\355\350\351";                                    // "Внешний";
const char mer30[] PROGMEM = "\307\345\360\352\340\353\356 \350 \362\360\363\341\340";          // "Зеркало и труба";
const char mer31[] PROGMEM = "\307\345\360\352\340\353\356 \350 \356\352\360\363\346.";         // "Зеркало и окруж.";
const char mer32[] PROGMEM = "\307\345\360\352\340\353\356 \350 \342\355\345\370\355.";         // "Зеркало и внешн.";
const char mer33[] PROGMEM = "< \315\345 \355\340\347\355\340\367\345\355\356 >";               // "< Не назначено >";
const char mer34[] PROGMEM = "\316\370\350\341\352\340";                                        // "Ошибка";
const char mer35[] PROGMEM = "-= COOL SCOPE =-";                                                // "-= COOL SCOPE =-";
const char mer36[] PROGMEM = VERSION " OLED";                                                   // "v1.3 OLED";
const char mer37[] PROGMEM = VERSION " LCD";                                                    // "v1.3 LCD";
const char mer38[] PROGMEM = "\322\345\361\362";                                                // "Тест";
const char mer39[] PROGMEM = "\317\350\362\340\355\350\345 \357\356 USB";                       // "Питание по USB";
const char mer40[] PROGMEM = "\317\360\345\344\363\357\360. \341\340\362\340\360\345\350";      // "Предупр. батареи";
const char mer41[] PROGMEM = "\315\340\357\360\377\346. \357\360\345\344\363\357\360.";         // "Напряж. предупр.";
const char mer42[] PROGMEM = "\301\340\362\340\360\345\377 \361\340\344\350\362\361\377!";      // "Батарея садится!";
const char mer43[] PROGMEM = "\302\345\355\362. \342\352\353\376\367\345\355\373";              // "Вент. включены";
const char mer44[] PROGMEM = "\302\345\355\362. \342\373\352\353\376\367\345\355\373";          // "Вент. выключены";
const char mer45[] PROGMEM = "\302\352\353";                                                    // "Вкл"
const char mer46[] PROGMEM = "\302\373\352\353";                                                // "Выкл"
const char mer47[] PROGMEM = "\337\347\373\352";                                                // "Язык";
const char mer48[] PROGMEM = "\300\355\343\353\350\351\361\352\350\351";                        // "Английский";
const char mer49[] PROGMEM = "\320\363\361\361\352\350\351";                                    // "Русский";
#endif
